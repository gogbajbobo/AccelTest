...
// STManagedTracker
#define COCOAPODS_POD_AVAILABLE_STManagedTracker
#define COCOAPODS_VERSION_MAJOR_STManagedTracker 0
#define COCOAPODS_VERSION_MINOR_STManagedTracker 0
#define COCOAPODS_VERSION_PATCH_STManagedTracker 1

// UDPushAuth
#define COCOAPODS_POD_AVAILABLE_UDPushAuth
#define COCOAPODS_VERSION_MAJOR_UDPushAuth 0
#define COCOAPODS_VERSION_MINOR_UDPushAuth 2
#define COCOAPODS_VERSION_PATCH_UDPushAuth 1
